...
#include "third_party/libwebp/src/imageio/image_enc.h"
...
#include "third_party/libwebp/src/imageio/imageio_util.h"
#include "third_party/libwebp/src/imageio/examples/unicode.h"
