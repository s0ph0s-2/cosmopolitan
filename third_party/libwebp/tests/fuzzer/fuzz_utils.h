...
#include "third_party/libwebp/tests/fuzzer/img_alpha.h"
#include "third_party/libwebp/tests/fuzzer/img_grid.h"
#include "third_party/libwebp/tests/fuzzer/img_peak.h"
