...
#ifndef ENCODER_BASE_COMPILER_SPECIFIC_H_
#define ENCODER_BASE_COMPILER_SPECIFIC_H_

// Macros for compiler version + nonstandard keywords, e.g. __builtin_expect.

#include <stdint.h>

#include "third_party/libjxltiny/encoder/base/sanitizer_definitions.h"
...
#endif  // ENCODER_BASE_COMPILER_SPECIFIC_H_
